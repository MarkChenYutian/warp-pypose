...
def get_bwd_tolerances(dtype: torch.dtype) -> dict:
    ...
    Note: The backward pass computes the analytical gradient via chain rule
    through quaternion representation. This matches the numerical gradient
    of the forward pass.
    """
...
class TestSo3MatBwdNumericalGradient:
...
class TestSo3MatWarpBackendIntegration:

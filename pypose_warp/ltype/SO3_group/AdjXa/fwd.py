...
_SO3_AdjXa_kernels = {
    1: SO3_AdjXa_fwd_kernel_1d,
    2: SO3_AdjXa_fwd_kernel_2d,
    3: SO3_AdjXa_fwd_kernel_3d,
    4: SO3_AdjXa_fwd_kernel_4d,
}
...
def SO3_AdjXa_fwd(X: pp.LieTensor, a: pp.LieTensor) -> pp.LieTensor:
    ...
    a_expanded = a_tensor.expand(*out_batch_shape, 3)
    ...
    wp.launch(
        kernel=_SO3_AdjXa_kernels[ndim],
        dim=out_batch_shape,
        device=X_wp.device,
...
__SO3_AdjXa_fwd_concrete_kernels = [
    # 1D kernels
    wp.overload(SO3_AdjXa_fwd_kernel_1d, dict(
    ...
    # 2D kernels
    wp.overload(SO3_AdjXa_fwd_kernel_2d, dict(
    ...
    # 3D kernels
    wp.overload(SO3_AdjXa_fwd_kernel_3d, dict(
    ...
    # 4D kernels
    wp.overload(SO3_AdjXa_fwd_kernel_4d, dict(

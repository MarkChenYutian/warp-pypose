"""
Automated benchmark runner for SO3 group operators.
...
from . import Mat, Inv, Log, Mul, Act, Act4, AdjXa, AdjTXa, JInvp
...
def create_operator_plot(op: OperatorInfo, results: list[BenchResult]):
    ...
    # Main title
    fig.suptitle(
        f'SO3 {op.name} Benchmark: Warp vs PyPose',
...
def main():
    ...
    print("=" * 80)
    print("SO3 Group Operators Benchmark Suite")
    print("=" * 80)
    print(f"Sizes: {SIZES}")
